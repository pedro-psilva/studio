                        ...
                        <Card className="mb-6 bg-muted/50">
                            ...
                            <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input id="valor_real" type="number" placeholder="Ex: 52000" />
                                </div>
                                <div className="space-y-2 md:col-span-2">
                                    <Label htmlFor="observacao">Observação</Label>
                                    <Input id="observacao" placeholder="Algum comentário sobre o resultado" />
                                </div>
                            </CardContent>
                             <CardContent className="flex justify-end gap-2">
                                <Button variant="outline" onClick={() => setIsAddingResult(false)}>Cancelar</Button>
                                <Button onClick={() => setIsAddingResult(false)}>Salvar Resultado</Button>
                            </CardContent>
                        </Card>
                    )}
