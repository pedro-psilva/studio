...
function ArcadaSuperiorFDI({ selectedTeeth, onToothClick }: { selectedTeeth: number[], onToothClick: (tooth: number) => void }) {
    return (
...
function ArcadaInferiorFDI({ selectedTeeth, onToothClick }: { selectedTeeth: number[], onToothClick: (tooth: number) => void }) {
    return (
